  ...
  <div id="Cforum">
    <form method="post">
      <p>
        ...
        <input class="form-control" name="NumCarte" type="text" placeholder="Numéro de Carte" required /><br>
        ...
        <input class="form-control" name="Montant" type="text" placeholder="Montant" required /><br> <br>
